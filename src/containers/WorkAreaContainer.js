...
import addButton, {addSingleInput, revealButtons, hideButtons} from '../modules/AddSurvey';
...
const WorkAreaContainer = connect(mapStateToProps, mapDispatchToProps)(WorkArea)
